...
export const searchParamsSchema = z.object({
  ...
  minBenchCount: z.coerce.number().min(0).optional(),
  minBarbellCount: z.coerce.number().min(0).optional(),
  ...
  hasAssaultRunner: z.string().optional(),
  ...
  hasEllipticalMachine: z.string().optional(),
  hasDeadliftPlatform: z.string().optional(),
  hasPullUpBar: z.string().optional(),
  hasDipStation: z.string().optional(),
  hasTrapBar: z.string().optional(),
  hasSafetySquatBar: z.string().optional(),
  hasLandmineAttachment: z.string().optional(),
  hasSwissBar: z.string().optional(),
  hasCamberedBar: z.string().optional(),
  hasEzBar: z.string().optional(),
  hasGluteHamDeveloper: z.string().optional(),
  hasReverseHyper: z.string().optional(),
  ...
  hasRomanChair: z.string().optional(),
  hasAbCrunchBench: z.string().optional(),
  hasTorsoRotationMachine: z.string().optional(),
  hasAbCrunchMachine: z.string().optional(),
  hasPreacherCurlBench: z.string().optional(),
  hasBicepCurlMachine: z.string().optional(),
  hasTricepExtensionMachine: z.string().optional(),
  hasDipMachine: z.string().optional(),
  hasChestPressMachine: z.string().optional(),
  hasInclineChestPressMachine: z.string().optional(),
  hasDeclineChestPressMachine: z.string().optional(),
  hasBenchRack: z.string().optional(),
  hasInclineBenchRack: z.string().optional(),
  ...
  hasPullOverMachine: z.string().optional(),
  hasLateralRaiseMachine: z.string().optional(),
  hasStandingLateralRaiseMachine: z.string().optional(),
  ...
  hasMultiPressMachine: z.string().optional(),
  hasMultiHipMachine: z.string().optional(),
  ...
  hasBeltSquatMachine: z.string().optional(),
  hasStandingCalfRaiseMachine: z.string().optional(),
  hasGluteExtensionMachine: z.string().optional(),
  hasHipThrustMachine: z.string().optional(),
  hasBoxingSandbag: z.string().optional(),
  hasBattleRope: z.string().optional(),
  hasFoamRoller: z.string().optional(),
  hasMedicineBall: z.string().optional(),
  hasExerciseStepper: z.string().optional(),
  hasAbRoller: z.string().optional(),
  hasMassageBall: z.string().optional(),
  ...
  hasTrx: z.string().optional(),
  hasResistanceBand: z.string().optional(),
  hasRings: z.string().optional(),
  hasYogaBlock: z.string().optional(),
  hasYogaMat: z.string().optional(),
  hasStretchingMachine: z.string().optional(),
  hasMobilityStick: z.string().optional(),
  hasWashroom: z.string().optional(),
  hasBathroom: z.string().optional(),
  hasChangingRoom: z.string().optional(),
  hasFreeWater: z.string().optional(),
  hasDrySauna: z.string().optional(),
  hasWetSauna: z.string().optional(),
  hasIceBath: z.string().optional(),
